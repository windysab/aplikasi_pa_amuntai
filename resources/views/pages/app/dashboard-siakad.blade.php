    ...
    <section class="section">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="card card-statistic-1">
                    ...
                    <div class="card-wrap">
                        ...
                        <div class="card-body">
                            <?php
                            // $currentYear = 2023; // get the current year
                               $currentYear = date('Y'); // get the current year
                               $query = DB::table('perkara_putusan')
                               ->whereYear('tanggal_minutasi', $currentYear)->get(); // use the current year in the query
                               $row = $query->count();
                               echo $row;
                            ?>
                        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                ...
                ->whereNull('tanggal_putusan')
                ->whereYear('tanggal_pendaftaran', 2018)->get();
                $row = $query->count();
                echo $row;
                ?>
                        </div>
